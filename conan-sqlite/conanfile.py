...
class ConanSqlite3(ConanFile):
    ...
    default_options = "shared=False", "fPIC=True", "threadsafe=1", "enable_column_metadata=False", \
                       "enable_explain_comments=False", "enable_fts3=False", "enable_fts4=False", \
                       "enable_fts5=False", "enable_json1=False", "enable_rtree=False", "omit_load_extension=False"
